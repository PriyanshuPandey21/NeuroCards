...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-chart-1-foreground shadow-lg shadow-chart-1/25 hover:shadow-xl hover:shadow-chart-1/30 hover:brightness-110",
        ...
        link: "text-chart-1 underline-offset-4 hover:underline",
        gradient: "bg-gradient-to-r from-chart-1 to-chart-2 text-white shadow-lg shadow-chart-1/25 hover:shadow-xl hover:shadow-chart-1/40 hover:brightness-110",
      },
      size: {
